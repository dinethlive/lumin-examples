    ...
    <main>
      ...
      {error && (
        <section className="mx-auto max-w-2xl px-6 pb-10">
          <div className="rounded-xl bg-[var(--color-pitta-soft)] px-4 py-3 text-sm text-foreground ring-1 ring-black/[0.05]">
...
const LOADING_STEPS = [
  ...
  "Matching products to your nature…",
];
    ...
    <section className="mx-auto max-w-5xl px-6 pb-24">
      ...
      <div className="mt-10">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Four products picked from our catalog to balance your constitution.
        </p>
